                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <select class="form-control js-country" name="country_id">
                                    <option value="-1" selected disabled>Select Department of an employee</option>
                            ...
                            <div class="col-md-4">
                                <select class="form-control js-states" name="state_id">
                                    <option value="-1" selected disabled>Select Designation of the Employee</option>

                                </select>
                            </div>
                            <div class="col-md-4">
                                <select class="form-control js-cities" name="city_id" >
                                    <option value="-1" selected disabled>Shift of the Employee</option>
                                </select>
                            </div>
                            <br><br>
                            <div class="col-md-4">
                                <input id="zip" type="text" class="form-control" name="zip" value="{{ old('zip') }}" required placeholder="Employee ID">
                        ...
                        {{-- <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ old('date_join') }}" name="date_join" class="form-control pull-right" id="hiredDate" required placeholder="Joining Date">
                                </div>
                        </div>
                        <br><br>
                            <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="input-group date">
                                ...
                                <input type="text" value="{{ old('email') }}" name="email" class="form-control pull-right"  required placeholder="Email adress">
                        </div>
                        <br><br>
                        <div class="col-md-12">
