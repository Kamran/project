                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('division.destroy', ['id' => $division->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('division.edit', ['id' => $division->id]) }}" title="Edit Division" class="btn btn-info col-sm-5 col-xs-6 btn-margin">
                        ...
                        <button type="submit" class="btn btn-danger col-sm-5 col-xs-6 btn-margin">
