                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('country.update', ['id' => $country->id]) }}">
                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div class="col-md-6">
                                Department Name <input id="name" type="text" class="form-control" name="name" value="{{ $country->name }}" required autofocus>
                            ...
                            <div class="col-md-6">
                                Code <input id="country_code" type="text" class="form-control" name="country_code" value="{{ $country->country_code }}" required>
