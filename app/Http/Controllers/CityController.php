...
class CityController extends Controller
{
    ...
    public function index()
    {
        ...
        $states = State::all();
        return view('system-mgmt/city/index', ['cities' => $cities,'states' => $states]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->intended('system-management/city')->with('success','shift Created Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->intended('system-management/city')->with('success','shift Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        City::where('id', $id)->delete();
         return redirect()->intended('system-management/city')->with('success','shift Deleted Successfully!');
    }
