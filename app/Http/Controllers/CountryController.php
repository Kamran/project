...
class CountryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->intended('system-management/country')->with('success','Department Created Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->intended('system-management/country')->with('success','Department Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        Country::where('id', $id)->delete();
         return redirect()->intended('system-management/country')->with('success','Department Deleted Successfully!');
    }
