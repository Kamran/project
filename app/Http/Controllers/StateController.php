...
class StateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('system-mgmt/state/index', ['states' => $states,'countries' => $countries]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->intended('system-management/state')->with('success','Designation Created Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->intended('system-management/state')->with('success','Designation Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        State::where('id', $id)->delete();
         return redirect()->intended('system-management/state')->with('success','Designation Deleted Successfully!');
    }
