...
class DepartmentController extends Controller
{
    ...
    {   
        ...
        return redirect()->intended('system-management/department')->with('success','Type Created Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->intended('system-management/department')->with('success','Type Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        Department::where('id', $id)->delete();
         return redirect()->intended('system-management/department')->with('success','Type Deleted Successfully!');
    }
